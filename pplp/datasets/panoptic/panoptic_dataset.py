...
from pplp.datasets.panoptic.panoptic_utils import PanopticUtils
...
class PanopticDataset:
    ...
    def _set_up_directories(self):
        ...
        # self.velo_dir = self._data_split_dir + '/ptclouds_3D'
    ...
    def load_samples(self, indices, OrientNet=False):
        ...
        for sample_idx in indices:
            ...
            if OrientNet:
                orientnet_result = self.panoptic_utils.get_orientnet_result(img_idx)
