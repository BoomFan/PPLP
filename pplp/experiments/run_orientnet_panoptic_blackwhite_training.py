...
from pplp.core.models.orientnet_panoptic_blackwhite_model import OrientBWModel
from pplp.core import trainer_orientnet as trainer
...
def train(model_config, train_config, dataset_config):
    ...
    with tf.Graph().as_default():
        if model_name == 'orient_model':
            model = OrientBWModel(model_config,
