    ...
    def run_latest_checkpoints(self):
        ...
        if ckpt_indices is not None:
            ...
            for ckpt_idx in ckpt_indices:
                ...
                # checkpoint_to_restore = '/home/fanbu/PPLP/src/PPLP/pplp/data/outputs/pplp_pedestrian_panoptic/checkpoints/pplp_pedestrian_panoptic-00109866'
                checkpoint_to_restore = '/home/boom/LidarPoseBEV/src/PPLP/pplp/data/outputs/pplp_pedestrian_panoptic/checkpoints/pplp_pedestrian_panoptic-00000000'
