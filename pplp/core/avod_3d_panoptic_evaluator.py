...
from pplp.core.models.avod_3d_panoptic_model import AvodModel
from pplp.core.models.rpn_avod_3d_panoptic_model import RpnModel
...
class Evaluator:
    ...
    def run_latest_checkpoints(self):
        ...
        if ckpt_indices is not None:
            ...
            for ckpt_idx in ckpt_indices:
                ...
                # checkpoint_to_restore = '/home/fanbu/PPLP/src/PPLP/avod/data/outputs/avod_3d_pedestrian_panoptic/checkpoints/avod_3d_pedestrian_panoptic-00240000'
                checkpoint_to_restore = '/home/boom/LidarPoseBEV/src/PPLP/avod/data/outputs/avod_3d_pedestrian_panoptic/checkpoints/avod_3d_pedestrian_panoptic-00270000'
    ...
    def get_avod_predicted_boxes_3d_and_scores(self, predictions,
        ...
        if box_rep == 'box_3d':
            ...
            # I know, I changed the orientaions back. Because we don't have to add anything to the angles.
            final_pred_boxes_3d[:, 6] = final_pred_orientations
