...
from pplp.core.models.avod_panoptic_model import AvodModel
from pplp.core.models.rpn_avod_panoptic_model import RpnModel
    ...
    def run_latest_checkpoints(self):
        ...
        if ckpt_indices is not None:
            ...
            for ckpt_idx in ckpt_indices:
                ...
                # checkpoint_to_restore = '/home/fanbu/PPLP/src/PPLP/avod/data/outputs/avod_pedestrian_panoptic/checkpoints/avod_pedestrian_panoptic-00160000'
                checkpoint_to_restore = '/home/boom/LidarPoseBEV/src/PPLP/avod/data/outputs/avod_pedestrian_panoptic/checkpoints/avod_pedestrian_panoptic-00160000'
