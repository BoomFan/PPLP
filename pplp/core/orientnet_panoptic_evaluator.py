    ...
    def run_latest_checkpoints(self):
        ...
        if ckpt_indices is not None:
            ...
            for ckpt_idx in ckpt_indices:
                ...
                checkpoint_to_restore = '/home/fanbu/PPLP/src/PPLP/pplp/data/outputs/orientation_pedestrian_panoptic/checkpoints/orientation_pedestrian_panoptic-00306952'
                # checkpoint_to_restore = '/home/boom/LidarPoseBEV/src/PPLP/pplp/data/outputs/orientation_pedestrian_panoptic/checkpoints/orientation_pedestrian_panoptic-00306952'
