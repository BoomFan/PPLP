...
class OrientBWModel(model.DetectionModel):
    ##############################
    ...
    def __init__(self, model_config, train_val_test, dataset):
        ...
        super(OrientBWModel, self).__init__(model_config)
    ...
    def _set_up_input_pls(self, testing=False):
        ...
        with tf.variable_scope('img_mrcnn_bbox_input'):
            ...
            tf.summary.image('img_croped_masked_input',
                             self.img_croped_masked_input,
                             max_outputs=None)
    ...
    def create_feed_dict(self, sample_index=None):
        ...
        image_input = 255.0 * np.ones([image_input.shape[0], image_input.shape[1], 3])
