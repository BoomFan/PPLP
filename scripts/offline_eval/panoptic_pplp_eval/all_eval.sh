...
do
	...
	# ./evaluate_object_3d_offline /home/boom/Downloads/cam_lidar_mocap_test_set/raw_static_segway_20181031/training/label_2 $1/$folder | tee -a ./results_$1.txt
	...
	./evaluate_object_3d_offline /home/boom/Panoptic/projects/bodypose2dsim/160422_ultimatum1/training/label_2 $1/$folder | tee -a ./results_$1.txt
	...
	# ./evaluate_object_3d_offline /home/boom/Panoptic/projects/bodypose2dsim/160226_haggling1/training/label_2 $1/$folder | tee -a ./results_$1.txt
