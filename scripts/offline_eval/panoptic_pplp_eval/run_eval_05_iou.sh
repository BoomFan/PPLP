...
# make_script =  /home/boom/LidarPoseBEV/src/PPLP/pplp/data/outputs/pplp_pedestrian_panoptic/predictions/panoptic_pplp_eval/run_eval_05_iou.sh
...
# results_dir =  /home/boom/LidarPoseBEV/src/PPLP/scripts/offline_eval/results_05_iou/
set -e

cd $1
echo "$3" | tee -a ./$4_results_05_iou_$2.txt

./evaluate_object_3d_offline_05_iou /home/boom/Panoptic/projects/bodypose2dsim/160422_ultimatum1/training/label_2 $2/$3 | tee -a ./$4_results_05_iou_$2.txt
